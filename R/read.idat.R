read.idat <- function(idatfiles, bgxfile, dateinfo=FALSE, tolerance=0, verbose=TRUE)
# Read idat data from gene expression BeadChips
# Matt Ritchie
# Created 30 September 2013. Modified on 14 January 2015 and 26 June 2015.
{
  if(!requireNamespace("illuminaio",quietly=TRUE)) stop("illuminaio package required but is not installed (or can't be loaded)")
